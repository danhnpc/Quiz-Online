...
public class DeleteQuestionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean result = dao.deleteQuestion(pk, isDelete);
            String searchValue= request.getParameter("txtSearchValue");
            String lastStatus = request.getParameter("txtStatus");
            String lastSubject = request.getParameter("txtSubject");
            if(result){
                url = "searchQuestion?btAction=Search&txtSearchQuestion="
                        + searchValue 
                        + "&txtStatus="
                        + lastStatus
                        + "&txtSubject="
